...
enum MessageType
{
  ...
  AODVTYPE_LPP = 5       //!< AODVTYPE_LPP /*etx*/
};
...
* \brief   Route Request (RREQ) Message Format
  ...
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  |     Type      |J|R|G|D|U| Res.|     ETX       |   Hop Count   |
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  |                            RREQ ID                            |
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
...
public:
   ...
   */
   RreqHeader (uint8_t flags = 0, uint8_t reserved = 0, uint8_t hopCount = 0,
              ...
              uint32_t originSeqNo = 0, uint8_t etxMetric = 0); /*etx*/
...
private:
  ...
  uint8_t        m_etxMetric;      ///< ETX metric
};
...
* \brief Route Reply (RREP) Message Format
  ...
  |                           Lifetime                            |
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  | ETX metric    |     xxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx          |
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  \endverbatim
*/
...
public:
  ...
  RrepHeader (uint8_t prefixSize = 0, uint8_t hopCount = 0, Ipv4Address dst =
                ...
                Ipv4Address (), Time lifetime = MilliSeconds (0), uint8_t etxMetric = 0); /*etx*/
  /**
   * \brief Get the type ID.
   * \return the object TypeId
   */
...
* \brief   Link probe packet (LPP) Message Format
  ...
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
// deleted since it is unnecesary:  |                   Originator IP Address                       |
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
  |                 Originator Sequence Number                    |
  +-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+-+
   \endverbatim
...
/* deleted since it is unnecesary
